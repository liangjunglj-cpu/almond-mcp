...
| --- | --- |
| App name | Almond MCP |
| Release | almondbridge 0.6.0-rc.4 / almond-mcp 0.6.0rc4 (prerelease) |
...
its Neo Swiss library interface. Browsing the included collection needs no
...
Primary file: `almondbridge-0.6.0-rc.4-rh8_0-win.yak`.
Optional upload wrapper: `almondbridge-0.6.0-rc.4-food4rhino.zip` containing the
same Yak and quickstart guide. Both are in `dist/release-0.6.0rc4/` after preparation.
